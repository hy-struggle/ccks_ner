...
from transformers import BertPreTrainedModel, ElectraPreTrainedModel, BertModel, ElectraModel
...
class ElectraForTokenClassification(ElectraPreTrainedModel):
    ...
    def get_dym_layer(self, outputs):
        ...
        hidden_stack = torch.stack(outputs[fusion_idx][-self.fusion_layers:],
                                   dim=0)  # (num_layers, bs, seq_len, hs)
        sequence_output = torch.sum(hidden_stack * self.dym_weight, dim=0)  # (bs, seq_len, hs)
        return sequence_output
