...
parser.add_argument('--ex_index', type=int, default=1, help="实验index")
...
parser.add_argument('--restore_file', type=str, default='best', required=False, help="reload before training")
