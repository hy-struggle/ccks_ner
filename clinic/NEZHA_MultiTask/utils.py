...
# 定义实体标注
EN_DICT = {
    '疾病和诊断': ['B-DIS', 'I-DIS', 'E-DIS', 'S-DIS'],
    '影像检查': ['B-SCR', 'I-SCR', 'E-SCR', 'S-SCR'],
    '实验室检验': ['B-LAB', 'I-LAB', 'E-LAB', 'S-LAB'],
    '手术': ['B-OPE', 'I-OPE', 'E-OPE', 'S-OPE'],
    '药物': ['B-MED', 'I-MED', 'E-MED', 'S-MED'],
    '解剖部位': ['B-POS', 'I-POS', 'E-POS', 'S-POS'],
    'Others': 'O'
}
...
class Params:
    ...
    def __init__(self, ex_index=1):
        ...
        # BIO标签列表
        self.bio_tags = ['B', 'I', 'O', 'E', 'S']
        # 用于CRF的标签
        self.bio_tags.extend(["<START_TAG>", "<END_TAG>"])
        # TYPE标签列表
        self.type_tags = list(IO2STR.keys())
